...
- Основная БД
  - Проставление преподавателем оценок и посещаемости студентам в таблицу Journal
  - Проставление преподавателем баллов за экзамен по предмету студентам в таблицу ExamMarks.
- Вторая БД
